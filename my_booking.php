  ...
  <body id="body">
   ...
   <section id="innerBanner"> 
    <div class="inner-content">
      <h2><span>Đơn đặt hàng của tôi</span></h2>
      <div> 
      </div>
    </div> 
  </section><!-- #Page Banner -->
            ...
            <div class="col-md-3 col-sm-3">
             ...
             <div class="col-md-8 col-sm-8">
              <div class="profile_wrap">
                <h5 class="uppercase underline">Đơn đặt hàng của tôi </h5>
                <div class="my_vehicles_list">
                  <ul class="vehicle_listing">
                    ...
                    if($query->rowCount() > 0)
                    {
                      ...
                      {  
                        ...
                        <li>
                          <h4 style="color:red">Mã đặt hàng. &nbsp;<?php echo htmlentities($result->BookingNumber);?></h4>
                          <div class="vehicle_img"> <a href="bike_details.php?vhid=<?php echo htmlentities($result->vid);?>"><img src="admin/img/vehicleimages/<?php echo htmlentities($result->Vimage1);?>" alt="image"></a> </div>
                          <div class="vehicle_title">

                            <h6><a href="bike_details.php?vhid=<?php echo htmlentities($result->vid);?>"> <?php echo htmlentities($result->BrandName);?> , <?php echo htmlentities($result->VehiclesTitle);?></a></h6>
                            <p><b>From </b> <?php echo htmlentities($result->FromDate);?> <b>To </b> <?php echo htmlentities($result->ToDate);?></p>
                            <div style="float: left"><p><b>Ghi chú:</b> <?php echo htmlentities($result->message);?> </p></div>
                          </div>
                          <?php if($result->Status==1)
                          { ?>
                            <div class="vehicle_status"> <a href="#" class="btn outline btn-xs active-btn">Chấp Nhận</a>
                         ...
                         <div class="vehicle_status"> <a href="#" class="btn outline btn-xs">Chưa chấp nhận</a>
                          <div class="clearfix"></div>
                        </div>
                        <?php 
                      } ?>
                  ...
                  <h5 class="text-center" style="color:red">Chưa có thông tin đặt</h5>
                  <?php 
                } ?>
              </ul>
            </div>
