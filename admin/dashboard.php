          ...
          <div class="row">
            <div class="col-md-3 stretch-card grid-margin">
              <div class="card bg-gradient-info card-img-holder text-white"style="height: 140px;">
                <div class="card-body" >
                  <h4 class="font-weight-normal mb-3">Người dùng đã đăng ký
                  </h4>
                  <?php 
            ...
            <div class="col-md-3 stretch-card grid-margin">
              <div class="card bg-gradient-success card-img-holder text-white"style="height: 140px;">
                <div class="card-body">
                  <h4 class="font-weight-normal mb-3">Sô lượng xe 
                  </h4>
                  <?php 
            ...
            <div class="col-md-3 stretch-card grid-margin">
              <div class="card bg-gradient-info card-img-holder text-white"style="height: 140px;">
                <div class="card-body">
                  <h4 class="font-weight-normal mb-3">Tổng số lượng đã được đặt
                  </h4>
                  <?php 
            ...
            <div class="col-md-3 stretch-card grid-margin">
              <div class="card bg-gradient-success card-img-holder text-white"style="height: 140px;">
                <div class="card-body">
                  <h4 class="font-weight-normal mb-3">Tổng hãng xe
                  </h4>
                  <?php 
