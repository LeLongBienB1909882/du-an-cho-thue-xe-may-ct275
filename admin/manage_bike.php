...
$query -> execute();
 echo "<script>alert('Xe đã bị xóa.');</script>";
}
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="modal-header">
                  <h5 class="modal-title" style="float: left;">Quản lý danh sách xe</h5>
                </div>
                ...
                <div class="table-responsive p-3">
                  <table class="table align-items-center table-flush table-hover table-bordered" id="dataTableHover">
                    ...
                    <tbody>
                      <?php
                      $sql = "SELECT tblvehicles.VehiclesTitle,tblvehicles.Vimage1,tblbrands.BrandName,tblvehicles.PricePerDay,tblvehicles.id from tblvehicles join tblbrands on tblbrands.id=tblvehicles.VehiclesBrand";
                      $query = $dbh -> prepare($sql);
                      $query->execute();
                        ...
                        { 
                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              <a href="manage_bike.php?del=<?php echo $row->id;?>" onclick="return confirm('Do you want to delete');"><i class="mdi mdi-delete text-danger"></i></i></a>
                            </td>
                          </tr>
                          <?php 
                          $cnt=$cnt+1;
