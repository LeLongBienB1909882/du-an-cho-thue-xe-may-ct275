...
if(isset($_GET['del']))
{
  ...
  $query -> execute();
  echo "<script>alert('Đã xóa một hãng xe.');</script>"; 
}
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
               <div class="modal-header">
                <h5 class="modal-title" style="float: left;">Quản lý hãng xe</h5>
              </div>
              <div class="col-md-12 mt-4">
                <form class="forms-sample" method="post" enctype="multipart/form-data" class="form-horizontal">
                  <div class="row ">
                    <div class="form-group col-md-6">
                      <label for="exampleInputName1">Tên hãng xe</label>
                      <input type="text" name="brandname" class="form-control" value="" id="brandname" placeholder="Nhập tên hãng xe" required>
                    </div>
                  </div>
                  <button type="submit" style="float: left;" name="save" class="btn btn-primary btn-sm mr-2 mb-4">Lưu</button>
                </form>
              </div>
            </div>
          </div>
              ...
              <div id="editData4" class="modal fade">
                <div class="modal-dialog modal-sm">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title">Hiệu chỉnh hãng xe</h5>
                      ...
                      {     
                        ...
                        <tr>
                          ...
                          <td class=" text-center"><a href="#"  class=" edit_data4" id="<?php echo  ($result->id); ?>" title="click to edit"><i class="mdi mdi-pencil-box-outline" aria-hidden="true"></i></a>
                            <a href="brand.php?del=<?php echo $result->id;?>" onclick="return confirm('Bạn có chắc là muốn xóa hãng xe này không');"><i class="mdi mdi-delete text-danger"></i></a></td>
