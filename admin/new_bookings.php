            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="modal-header">
                  <h5 class="modal-title" style="float: left;">Quản lý đặt xe</h5>
                </div>
                      ...
                      if($query->rowCount() > 0)
                      {
                        foreach($results as $result)
                        {
                          ...
                          <tr>
                            ...
                            <td>
                             <a href="edit_bike.php?id=<?php echo htmlentities($result->vid);?>"><?php echo htmlentities($result->VehiclesTitle);?></a>
                            </td>
                            ...
                            <td>
                              <a href="booking_details.php?bid=<?php echo htmlentities($result->id);?>">Xem chi tiêt</a>
                            </td>
