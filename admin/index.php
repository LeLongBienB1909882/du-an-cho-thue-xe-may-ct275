    ...
    <div class="container-scroller">
        ...
        <a href="../index.php">Trang chủ</a>
                            ...
                            <div class="brand-logo text-center" >
                                <img class="img-avatar mb-3" src="../img/logo.png" alt="Logo">
                            </div>
                            <form role="form" id=""  method="post" enctype="multipart/form-data" class="form-horizontal">  
                                ...
                                <div class="mt-3">
                                    <button name="login" class="btn btn-block btn-gradient-primary btn-lg font-weight-medium auth-form-btn">Đăng nhập</button>
                                </div>
                            </form>
                        </div>
                    </div>
